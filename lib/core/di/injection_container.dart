...
import 'package:flutter_practice11/data/datasources/auth/auth_local_datasource.dart';
import 'package:flutter_practice11/data/datasources/vehicles/vehicles_local_datasource.dart';
import 'package:flutter_practice11/data/datasources/expenses/expenses_local_datasource.dart';
import 'package:flutter_practice11/data/datasources/service/service_local_datasource.dart';
import 'package:flutter_practice11/data/datasources/tips/tips_local_datasource.dart';
import 'package:flutter_practice11/data/datasources/places/places_local_datasource.dart';
import 'package:flutter_practice11/data/datasources/profile/profile_local_datasource.dart';
import 'package:flutter_practice11/data/datasources/settings/settings_local_datasource.dart';

import 'package:flutter_practice11/data/repositories/auth_repository_impl.dart';
import 'package:flutter_practice11/data/repositories/vehicles_repository_impl.dart';
import 'package:flutter_practice11/data/repositories/expenses_repository_impl.dart';
import 'package:flutter_practice11/data/repositories/service_repository_impl.dart';
import 'package:flutter_practice11/data/repositories/tips_repository_impl.dart';
import 'package:flutter_practice11/data/repositories/places_repository_impl.dart';
import 'package:flutter_practice11/data/repositories/profile_repository_impl.dart';
import 'package:flutter_practice11/data/repositories/settings_repository_impl.dart';

import 'package:flutter_practice11/domain/repositories/auth_repository.dart';
import 'package:flutter_practice11/domain/repositories/vehicles_repository.dart';
import 'package:flutter_practice11/domain/repositories/expenses_repository.dart';
...
import 'package:flutter_practice11/domain/usecases/profile/get_profile_usecase.dart';
import 'package:flutter_practice11/domain/usecases/profile/update_profile_usecase.dart';
